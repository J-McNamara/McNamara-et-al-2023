...
# 
# Output is written to the 'output' directory in the current directory.
#
# This script took ~1 hour to process a ~30 Gb fastq.gz file on a 2016 4-core Lenovo Thinkcentre desktop with 8 Gb memory, outputting a ~100 Mb file
#
##############################
...
### Count the barcodes
####################
# This code block is a pipe to the output file
